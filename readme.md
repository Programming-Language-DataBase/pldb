...
PLDB is a comprehensive public domain database containing over 135,000 facts about more than 5,000 programming languages. The project includes both the complete dataset and the website code for [pldb.info](http://pldb.info).
...
- **Web Interface**: Browse the data through an intuitive web interface at [pldb.info](http://pldb.info)

## 📊 Data Downloads

Access the complete dataset in your preferred format:

- **CSV**: [pldb.info/pldb.csv](http://pldb.info/pldb.csv)
- **TSV**: [pldb.info/pldb.tsv](http://pldb.info/pldb.tsv)
- **JSON**: [pldb.info/pldb.json](http://pldb.info/pldb.json)

Full documentation for the data formats is available at [pldb.info/csv.html](http://pldb.info/csv.html)
...
- View detailed language statistics at [pldb.info/pages/about.html](http://pldb.info/pages/about.html)
...
Learn more about the ranking algorithm at [pldb.info/pages/the-rankings-algorithm.html](http://pldb.info/pages/the-rankings-algorithm.html)
...
- **Main Website**: [pldb.info](http://pldb.info)
- **About Page**: [pldb.ifno/pages/about.html](http://pldb.info/pages/about.html)
- **Acknowledgements**: [pldb.info/pages/acknowledgements.html](http://pldb.info/pages/acknowledgements.html)

## 📖 Citation

This project is dedicated to the public domain. When using PLDB, we appreciate attribution but it's not required. All sources are listed at [pldb.info/pages/acknowledgements.html](http://pldb.info/pages/acknowledgements.html).
